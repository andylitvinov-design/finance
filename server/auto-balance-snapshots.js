...
export const EXPECTED_PROVIDER_BALANCES = [
  ...
  {
    provider: "privatbank",
    channel: "приват 24-евро",
    currency: "EUR",
    source: "privatbank_auto",
    active_from: "2026-05-02",
    inactive_reason: "2026-05-01 owner opening has USD-only confirmation without trusted native EUR amount; daily numeric coverage starts on 2026-05-02",
  },
  ...
  { provider: "privatbank", channel: "приват-фоп", currency: "UAH", source: "privatbank_auto" },
  {
    ...
    channel: "Яндекс руб",
    currency: "RUB",
    source: "yoomoney_auto",
    active_from: "2026-05-02",
    inactive_reason: "2026-05-01 owner opening has USD-only confirmation without trusted native RUB amount; daily numeric coverage starts on 2026-05-02",
  },
  ...
  },
  {
    ...
    source: "tdbank_auto",
    active_from: "2026-05-02",
    inactive_reason: "2026-05-01 owner opening has USD-only confirmation without trusted native CAD amount; daily numeric coverage starts on 2026-05-02",
  },
  {
    provider: "payoneer",
    channel: "Payoneer - eur",
    currency: "EUR",
    source: "payoneer_auto",
    active_from: "2026-05-02",
    inactive_reason: "2026-05-01 owner opening has USD-only confirmation without trusted native EUR amount; daily numeric coverage starts on 2026-05-02",
  },
