(function initManualLedgerContract(root, factory) {
  ...
  const LEDGER_V2_SOURCE_BY_LEGACY = {
    ...
    yandex: "yoomoney",
      ...
      paypal_personal: "paypal_personal_manual",
    paypal_personal_manual: "paypal_personal_manual",
    manual_provider_confirmed: "paypal_personal_manual",
    wise: "wise",
    binance: "binance",
    binance_spot: "binance",
    binance_save: "binance",
    binance_savings: "binance",
    crypto: "binance",
    usdt: "binance",
    usdt_trc20: "binance",
    usdt_erc20: "binance",
